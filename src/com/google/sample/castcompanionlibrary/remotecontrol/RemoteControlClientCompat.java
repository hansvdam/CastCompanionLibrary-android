...
/**
 * RemoteControlClient enables exposing information meant to be consumed by remote controls capable of displaying
 * metadata, artwork and media transport control buttons. A remote control client object is associated with a media
 * button event receiver. This event receiver must have been previously registered with {@link
 * android.media.AudioManager#registerMediaButtonEventReceiver(android.content.ComponentName)} before the
 * RemoteControlClient can be registered through {@link android.media.AudioManager#registerRemoteControlClient(android.media.RemoteControlClient)}
 * .
 */
@SuppressWarnings({
        "rawtypes", "unchecked"
...
public class RemoteControlClientCompat {
     ...
     *
     * @param startEmpty Set to false if you want the MetadataEditor to contain the metadata that was previously applied
     *                   to the RemoteControlClient, or true if it is to be created empty.
     ...
     *
     * @param state The current playback state, one of the following values: {@link android.media.RemoteControlClient#PLAYSTATE_STOPPED},
     *              {@link android.media.RemoteControlClient#PLAYSTATE_PAUSED}, {@link android.media.RemoteControlClient#PLAYSTATE_PLAYING},
     *              {@link android.media.RemoteControlClient#PLAYSTATE_FAST_FORWARDING} , {@link
     *              android.media.RemoteControlClient#PLAYSTATE_REWINDING} , {@link android.media.RemoteControlClient#PLAYSTATE_SKIPPING_FORWARDS}
     *              , {@link android.media.RemoteControlClient#PLAYSTATE_SKIPPING_BACKWARDS} , {@link
     *              android.media.RemoteControlClient#PLAYSTATE_BUFFERING} , {@link android.media.RemoteControlClient#PLAYSTATE_ERROR}.
     */
     ...
     *
     * @param transportControlFlags A combination of the following flags: {@link android.media.RemoteControlClient#FLAG_KEY_MEDIA_PREVIOUS}
     *                              , {@link android.media.RemoteControlClient#FLAG_KEY_MEDIA_REWIND} , {@link
     *                              android.media.RemoteControlClient#FLAG_KEY_MEDIA_PLAY} , {@link
     *                              android.media.RemoteControlClient#FLAG_KEY_MEDIA_PLAY_PAUSE} , {@link
     *                              android.media.RemoteControlClient#FLAG_KEY_MEDIA_PAUSE} , {@link
     *                              android.media.RemoteControlClient#FLAG_KEY_MEDIA_STOP} , {@link
     *                              android.media.RemoteControlClient#FLAG_KEY_MEDIA_FAST_FORWARD} , {@link
    ...
    /**
     * Class used to modify metadata in a {@link android.media.RemoteControlClient} object. Use {@link
     * android.media.RemoteControlClient#editMetadata(boolean)} to create an instance of an editor, on which you set the
     * metadata for the RemoteControlClient instance. Once all the information has been set, use {@link #apply()} to
     * make it the new metadata that should be displayed for the associated client. Once the metadata has been
    ...
    public class MetadataEditorCompat {
        ...
        /**
         * Adds textual information to be displayed. Note that none of the information added after {@link #apply()} has
         ...
         *              android.media.MediaMetadataRetriever#METADATA_KEY_DATE} , {@link android.media.MediaMetadataRetriever#METADATA_KEY_GENRE}
         *              , {@link android.media.MediaMetadataRetriever#METADATA_KEY_TITLE} , {@link
         *              android.media.MediaMetadataRetriever#METADATA_KEY_WRITER} .
         * @param value The text for the given key, or {@code null} to signify there is no valid information for the
         *              field.
         * @return Returns a reference to the same MetadataEditor object, so you can chain put calls together.
         */
         ...
         *
         * @param key    the identifier of the bitmap to set. The only valid value is {@link #METADATA_KEY_ARTWORK}
        ...
        /**
         * Adds numerical information to be displayed. Note that none of the information added after {@link #apply()}
        ...
        /**
         * Clears all the metadata that has been set since the MetadataEditor instance was created with {@link
        ...
        /**
         * Associates all the metadata that has been set since the MetadataEditor instance was created with {@link
         * android.media.RemoteControlClient#editMetadata(boolean)}, or since {@link #clear()} was called, with the
         * RemoteControlClient. Once "applied", this MetadataEditor cannot be reused to edit the RemoteControlClient's
         * metadata.
         */
        public void apply() {
            if (sHasRemoteControlAPIs) {
