...
/**
 * An interface to abstract {@link MiniController} so that other components can also control the MiniControllers.
 * Clients should code against this interface when they want to control the provided {@link MiniController} or other
