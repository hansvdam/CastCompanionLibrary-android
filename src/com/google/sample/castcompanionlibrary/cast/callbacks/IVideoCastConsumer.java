...
public interface IVideoCastConsumer extends IBaseCastConsumer {
    ...
    /**
     * Called when the application is successfully launched or joined. Upon successful connection, a session ID is
     * returned. <code>wasLaunched</code> indicates if the application was launched or joined.
     */
    public void onApplicationConnected(ApplicationMetadata appMetadata,
            String sessionId, boolean wasLaunched);

    /**
     * Called when an application launch has failed. Failure reason is captured in the <code>errorCode</code> argument.
     * Here is a list of possible values: <ul> <li>4 : Application not found <li>5 : Application not currently running
     * <li>6 : Application already running </ul> If this method returns <code>true</code>, then the library will provide
     * an error dialog to inform the user. Clients can extend this method and return <code>false</code> to handle the
     ...
     * @param errorCode An error code indicating the reason for the disconnect. One of the error constants defined in
     *                  CastErrors.
     */
